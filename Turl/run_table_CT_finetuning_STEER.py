...
from data_loader.CT_Wiki_data_loaders_STEER import *
...
def main():
    ...
    # STEER arguments
    parser.add_argument("--labeled_data_size", type=str, default=1)
    parser.add_argument("--unlabeled_data_size", type=str, default="absolute")
    parser.add_argument("--test_data_size", type=str, default=20.00)
    ...
    if args.do_train:
        ...
        train_dataset = WikiCTDataset(args.data_dir, entity_vocab, type_vocab, labeled_data_size=args.labeled_data_size, unlabeled_data_size=args.unlabeled_data_size, test_data_size=args.test_data_size, random_state=args.random_state, data_split_set="labeled", add_STEER_train_data=args.add_STEER_train_data, max_input_tok=500, src="train_dev_test", max_length=[
                                      50, 10, 10], force_new=False, tokenizer=None)
        if args.do_eval or args.evaluate_during_training:
            eval_dataset = WikiCTDataset(args.data_dir, entity_vocab, type_vocab, labeled_data_size=args.labeled_data_size, unlabeled_data_size=args.unlabeled_data_size, test_data_size=args.test_data_size, random_state=args.random_state, data_split_set="test", add_STEER_train_data=False, max_input_tok=500, src="train_dev_test", max_length=[
                                        50, 10, 10], force_new=False, tokenizer=None)
        else:
            eval_dataset = None
