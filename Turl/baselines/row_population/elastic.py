...
STEERSTIC_HOSTS = ES_config.get("host")
STEERSTIC_SETTINGS = ES_config.get("settings")


class Elastic(object):
    FIELD_CATCHALL = "catchall"
    FIELD_STEERSTIC_CATCHALL = "_all"
    ...
    def __init__(self, index_name):
        self.__es = Elasticsearch(hosts=STEERSTIC_HOSTS)
